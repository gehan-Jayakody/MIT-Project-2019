	...
	<ul class="nav">
	  ...
	  <li class="nav-item">
		...
		<div class="collapse" id="portfolio">
		  <ul class="nav flex-column sub-menu">
			...
			<?php if($_SESSION['user_role']=='110'){echo "<!--";} ?>
			<li class="nav-item"> <a class="nav-link" href="#" onclick="porfolio_Details()">Details</a></li>
			<?php if($_SESSION['user_role']=='110'){echo "-->";} ?>
			<?php if($_SESSION['user_role']=='110' || $_SESSION['user_role']=='120'){echo "<!--";} ?>
			<li class="nav-item"> <a class="nav-link" href="#" onclick="porfolio_Transfer()">Transfer</a></li>
			<?php if($_SESSION['user_role']=='110' || $_SESSION['user_role']=='120'){echo "-->";} ?>
			<li class="nav-item"> <a class="nav-link" href="#" onclick="company_hitory()">Company History</a></li>
		  </ul>
		</div>
	  </li>
	  <?php if($_SESSION['user_role']=='110' || $_SESSION['user_role']=='120'){echo "<!--";} ?>
	  <li class="nav-item">
		...
		<div class="collapse" id="Instruments">
		  <ul class="nav flex-column sub-menu">
			...
			<li class="nav-item"> <a class="nav-link" href="#" onclick="instrument_holding()">Instrument Report</a></li>
		  </ul>
		</div>
	  </li>
	  <?php if($_SESSION['user_role']=='110' || $_SESSION['user_role']=='120'){echo "-->";} ?>
	  <?php if($_SESSION['user_role']=='110' || $_SESSION['user_role']=='130'){echo "<!--";} ?>
	  <li class="nav-item">
	  ...
	  <li class="nav-item">
		...
		<div class="collapse" id="compliance_risk">
		  <ul class="nav flex-column sub-menu">
		    <?php if($_SESSION['user_role']=='130'){echo "<!--";} ?>
	  ...
	  <?php if($_SESSION['user_role']=='110' || $_SESSION['user_role']=='120' || $_SESSION['user_role']=='130'){echo "<!--";} ?>
	  <li class="nav-item">
