	  ...
	  <form class="needs-validation" action="modules/user/user_add.php" method="POST" onsubmit="return submitForm(this)" novalidate>
		  <div class="form-group row">
			 ...
			 <div class="col-3 stretch-card">
			   <input type="text" class="form-control" name="login_name" placeholder="Login ID Required" readonly>
		...
		<div class="form-group row">
			...
			<div class="col-3 stretch-card" align="center">
				<button type="submit" class="btn btn-gradient-info btn-rounded btn-fw" id="submit" name="submit" value="submit" onclick="checkInput()">Update</button>
			</div>
		</div>
	  </form>
	</div>
