...
if($_POST){
	...
	if($user->passwdConfirm()){
		...
		$alerttype = 'alert-danger';
		$alert = 'The Old Password you specified is not Matched!!.';
	}
}
?>
<!DOCTYPE html>
...
<div class="col-12 grid-margin">
  <div class="card text-black bg-secondary mb-3">
	<div class="card-body">
	  <form class="needs-validation" action="modules/user/user_passwd_reset_1.php" method="POST" onsubmit="return submitForm(this)" novalidate>
		  <div class="form-group row">
			 <label class="col-3 stretch-card">Login ID<p>&nbsp;</p>:-<p>&nbsp;</p></label>
			 <div class="col-3 stretch-card">
			   <input type="text" class="form-control" name="login_name" value="Ramesh" readonly>
			 </div>
		  </div>
		  <div class="form-group row">
			 <label class="col-3 stretch-card"><p class="text-danger"><sup>*</sup></p>Old Password<p>&nbsp;</p>:-<p>&nbsp;</p></label>
			 <div class="col-4 stretch-card">
			   <input type="password" class="form-control" name="old_password" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"  required>
		  ...
		  <div class="form-group row">
			 <label class="col-3 stretch-card"><p class="text-danger"><sup>*</sup></p>New Password<p>&nbsp;</p>:-<p>&nbsp;</p></label>
			 <div class="col-4 stretch-card">
		  ...
		  <div class="form-group row">
			 <label class="col-3 stretch-card">Confirm New Password<p>&nbsp;</p>:-<p>&nbsp;</p></label>
			 <div class="col-4 stretch-card">
